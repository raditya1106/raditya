;(function (window) {
  ...
  let texts = ['TAP NENG DI AE:)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'METT', 'DELOK EN JAL', 'KATA IKI', 'KYONE ENEK SENG ANEH', 'AYO PENCET NEH', 'AKU GA NGAPUSI ', 'PENCET LAGI', 'AKU NGERTI WE MESTI PEGEL', 'TAPI IKI BENER ENEK SENG ANEH', 'AKU JANJI', 'IKI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'ENEH METT KURANG PENCETT', 'AYO TOO', 'IKI TENAN WESS TERAKHIRR', 'YAUWES PENCET TERUS', 'AKU', 'SENENG', 'KOWE METT', 'HEHEEEE', 'BYE', 'MAAPIN AKU YA', 'NEK MARAI KOWE PEGEL HEHEE']
